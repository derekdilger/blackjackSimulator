...
public class Tester
{
    ...
    public static void main(String [] args)
    {
        ...
        int balancedTrifecta3 = 0;
        int balancedTrifecta4 = 0;
        int balancedTrifecta5 = 0;
        int balancedTrifecta6 = 0;
        int balancedTrifecta7 = 0;
        int balancedTrifecta8 = 0;
        int balancedTrifecta9 = 0;
        int balancedTrifecta10 = 0;
        int balancedTrifecta11 = 0;
        int balancedTrifecta12 = 0;
        int balancedTrifecta13 = 0;

        int handsDealt = 0;
        int numDealerBusts = 0;
        int numRFwins = 0;
        int numTrifectas = 0;
        int numBalancedTrifectas = 0;
        while (handsDealt < Integer.MAX_VALUE)
        {
            ...
            if (dealerHand.computeHandValue() > 21) 
            {
                //numDealerBusts++;
        ...
        System.out.println("max int is " + Integer.toString(maxVal) );
